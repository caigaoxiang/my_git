...
/**
 * <p>
 * YzymeAlt類主要用於-.将民政主要信息同步至前置机数据库中
 * </p>
 * <p>
...
//		}
		String sql = "SELECT  t.MZ_ID as guid, t.TYSHXYDM as xydm, t.JGMC as jgmc,a.RDDBRXM as fddbr,a.FDDBRZJHM as fddbr_zjhm, " +
				"t.ZCRQ as clrq,t.JGDZ as zcdz ,t.DATASTUTS as zt ,t.ZCH as zch ,t.LASTDATE as hzrq, " +
				"t.JYFW as jyfw ,t.ZCZJ as zczj ,t.PZJGDM as djglbm ,t.YXQQS as yxq_ks,t.YXQJZ as yxq_js," +
				" t.DHHM as lxdh,t.TBRXM as lxr, t.JJLX2011 as jjlx,t.JGDZ as scjydz,t.XZQH as xzqh," +
				"t.LASTDATE as  createtime ,t.MZ_ID as  gdtzr  from (SELECT row_number() over ( partition BY TYSHXYDM ORDER BY LASTDATE ) AS ids,MZ_ID," +
				"TYSHXYDM,JGMC,ZCRQ,JGDZ,DATASTUTS,ZCH,LASTDATE,JYFW,ZCZJ,PZJGDM,yxqqs,yxqjz,DHHM,TBRXM,JJLX2011," +
				"XZQH,FDDBR,JGDM from  MZ_INFO ) t " +
				",(select row_number() over ( partition BY JG_ID ORDER BY S_EXT_TIMESTAMP ) AS ids,JG_ID,RDDBRXM,FDDBRZJHM from FR_INFO )  a " +
				"where  t.JGDM = a.JG_ID and t.ids = a.ids ";
